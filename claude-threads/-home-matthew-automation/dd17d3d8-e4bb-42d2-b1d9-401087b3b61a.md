# Session `dd17d3d8-e4bb-42d2-b1d9-401087b3b61a`

- **Source file:** `/home/matthew/.claude/projects/-home-matthew-automation/dd17d3d8-e4bb-42d2-b1d9-401087b3b61a.jsonl`
- **Working dir:** `/home/matthew/automation`
- **Started:** 2026-05-23T00:33:22.593Z
- **Last activity:** 2026-05-23T00:33:23.807Z
- **Messages:** 1 user / 0 assistant

---

## user — 2026-05-23T00:33:23.808Z
...
ASK MOTIVATION EARLY:
- In the first 1-2 turns, work in at least one motivation question. Not just budget/beds — WHY they're moving.
- Options: "What's driving the move?" / "When ideally are you in?" / "What does your day-to-day look like once you're in?" / "Anything you're moving toward — or away from?"
- Motivation reveals timeline + tradeoffs + lets you pitch deal-mechanics later. Don't dump rate/financing expertise until you've heard the WHY.
...
- A reply is JUICY if the lead does ANY of these:
...
- If JUICY: prepend your reply with the literal token "JUICY: " followed by a one-line reason, then a newline, then the message. Example:
  JUICY: Asked about financing + timeline
  Hey Sarah — great question on financing...
